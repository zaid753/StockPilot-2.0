...
export const ReceiptIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M3 2.25a.75.75 0 0 1 .75.75v.54l1.838-.46a9.75 9.75 0 0 1 6.725.738l.108.054a8.25 8.25 0 0 0 5.58.652l3.109-.732a.75.75 0 0 1 .917.81 47.784 47.784 0 0 0 .005 10.337.75.75 0 0 1-.574.812l-3.123.733a9.75 9.75 0 0 1-6.408-.371l-.148-.048A11.262 11.262 0 0 0 9 15.405l-2.318.58a3 3 0 1 0 1.528 5.818l4.985-1.245a.75.75 0 0 1 .983.496l1.863 7.45a.75.75 0 0 1-.959.903l-3.715-.928a5 5 0 0 1-3.634-3.454l-.115-.461a.75.75 0 0 1 .547-.907ZM3.75 17.25v.75c0 .414.336.75.75.75h15a.75.75 0 0 0 .75-.75v-.75a.75.75 0 0 0-.75-.75h-15a.75.75 0 0 0-.75.75Z" clipRule="evenodd" />
        <path d="M10.5 2.25a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5a.75.75 0 0 1 .75-.75ZM13.5 2.25a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5a.75.75 0 0 1 .75-.75Z" />
    </svg>
);

export const CurrencyRupeeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM9 7.5A.75.75 0 0 1 9.75 6.75h6a.75.75 0 0 1 0 1.5h-2.343a3.75 3.75 0 0 1-3.626 3.25V12h3.692a.75.75 0 0 1 0 1.5H9.781v.834l3.1 4.133a.75.75 0 0 1-1.2.9l-3.75-5a.75.75 0 0 1-.131-.45V13.5h-1.5a.75.75 0 0 1 0-1.5h1.5v-.5a5.25 5.25 0 0 0 2.25-4.5H9.75A.75.75 0 0 1 9 7.5Z" clipRule="evenodd" />
    </svg>
);
...
export const ExpiryAlertIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v4.75l-2.625 1.5a.75.75 0 0 0 .75 1.3l3.375-1.928a.75.75 0 0 0 .375-.65V6Z" clipRule="evenodd" />
    </svg>
);

export const SmartMatchIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M19.902 4.098a3.75 3.75 0 0 0-5.304 0l-4.5 4.5a3.75 3.75 0 0 0 1.035 6.037.75.75 0 0 1-.025 1.052l-.966.966a3.75 3.75 0 0 0 5.304 0l4.5-4.5a3.75 3.75 0 0 0-1.035-6.037.75.75 0 0 1 .025-1.052l.966-.966ZM15.06 1.83a5.25 5.25 0 0 0-7.425 0l-4.5 4.5a5.25 5.25 0 0 0 0 7.425l.966.966a5.263 5.263 0 0 0 1.448 3.815 5.25 5.25 0 0 0 7.425 0l4.5-4.5a5.25 5.25 0 0 0 0-7.425l-.966-.966a5.263 5.263 0 0 0-1.448-3.815ZM9 12.75a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H9.75a.75.75 0 0 1-.75-.75V12.75Z" clipRule="evenodd" />
    </svg>
);
